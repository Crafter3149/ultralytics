...
| ID | 組 | 名稱 | 依賴 | 採納/鎖定條件 | 狀態 | AP | AP@0.5 | AP@0.75 | AP_small |
|----|----|------|------|---------------|------|----|--------|---------|----------|
| E0 | — | Baseline yolo26n | — | (anchor) | ⬜ | | | | |
| E_NWD | A | CIoU → NWD | E0 | ΔAP ≥ +0.5 → 永久 | ⬜ | | | | |
| E_DFL | A | reg_max 1 → 4 | E0 | ΔAP ≥ +0.5 → 永久 | ⬜ | | | | |
| E_FOCAL | A | cls BCE → focal | E0 | imbalance↓ 或 ΔAP ≥ +0.3 | ⬜ | | | | |
| E0+ | — | E0 + A 組勝出 | A 全收 | (新 baseline) | ⬜ | | | | |
| E1 | B | +P2 head (P2/P3/P4/P5) | E0+ | 比 E0+ ΔAP ≥ +1 | ⬜ | | | | |
| E2 | B | P1/P2/P3（無 P4/P5） | E0+ | 比 E1 ΔAP ≥ +1 | ⬜ | | | | |
...
| 結果 | 行動 |
|------|------|
| ΔAP ≥ +0.5 或 ΔAP_small ≥ +1.0 | 🔒 永久採納，寫入 E0+ default |
| -0.3 ≤ ΔAP < +0.5 且 AP@0.75 上升 | 🔒 採納（precision 增益） |
| -0.3 ≤ ΔAP < +0.5 且 AP@0.75 持平 | ⏸ 保留代碼，不採納 |
| ΔAP < -0.3 | ❌ reject |
